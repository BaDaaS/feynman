...
Human-readable mirror of the blueprint dependency graph (prompt.md §3, §9.4). This
...
The Tier-0 vertical slice is complete across all three layers and verified.
...
### Concept: the qubit and the Pauli operators - COMPLETE (three layers)
...
### Concept: observables and expectation values - COMPLETE (three layers)
...
### Concept: the Born rule - COMPLETE (three layers)
...
### Concept: unitary evolution / probability conservation - COMPLETE (three layers)
...
### Concept: composite systems and entanglement - COMPLETE (three layers)
...
**no-cloning**. These use the tensor and SVD machinery. Add each concept's three
